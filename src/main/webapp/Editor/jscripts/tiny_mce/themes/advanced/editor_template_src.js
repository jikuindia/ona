...
var TinyMCE_AdvancedTheme = {
	...
	getControlHTML : function(button_name) {
		...
		switch (button_name) {
			...
			case "styleselect":
				return '<select id="{$editor_id}_styleSelect" onmousedown="tinyMCE.themes.advanced._setupCSSClasses(\'{$editor_id}\');" name="{$editor_id}_styleSelect" onfocus="tinyMCE.addSelectAccessibility(event,this,window);" onchange="tinyMCE.execInstanceCommand(\'{$editor_id}\',\'mceSetCSSClass\',false,this.options[this.selectedIndex].value);" class="mceSelectList">'+
					'<option value="0">{$style_select_options}</option>'+
						'<option value="tah9">Style 9px</option>'+
						'</select>';
			...
			case "fontsizeselect":
				return '<select id="{$editor_id}_fontSizeSelect" name="{$editor_id}_fontSizeSelect" onfocus="tinyMCE.addSelectAccessibility(event, this, window);" onchange="tinyMCE.execInstanceCommand(\'{$editor_id}\',\'FontSize\',false,this.options[this.selectedIndex].value);" class="mceSelectList">'+
						...
						'<option value="1">1 (8 hhpt)</option>'+
						'<option value="9px">2 (9 pt)</option>'+
						'<option value="2">3 (10 pt)</option>'+
						'<option value="3">4 (12 pt)</option>'+
						'<option value="4">5 (14 pt)</option>'+
						'<option value="5">6 (18 pt)</option>'+
						'<option value="6">7 (24 pt)</option>'+
						'<option value="7">8 (36 pt)</option>'+
						'</select>';
